<x-guest-layout>
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                <x-label for="name" value="{{ __('Full legal name') }}" />
            ...
            <div class="mt-4">
                <x-label for="bsn" value="{{ __('Bsn') }}" />
                <x-input id="bsn" class="block mt-1 w-full" type="number" name="bsn" :value="old('bsn')" required autocomplete="bsn" />
            </div>
